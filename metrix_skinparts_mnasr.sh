...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/openatv/main/metrix_skinparts_mnasr_030624.tar.gz"
wait
tar -xzf metrix_skinparts_mnasr_030624.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/metrix_skinparts_mnasr_030624.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
